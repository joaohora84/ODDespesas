...
public class HomeFragment extends Fragment {
    ...
    private void carregarDespesasDemonstracao() {
        // Aqui você deve substituir por uma chamada real ao seu repositório
        despesasList.clear();

        // Adicionar algumas despesas de exemplo
        despesasList.add(new Despesa("Supermercado", 352.45, "01/03/2025", "Alimentação"));
        despesasList.add(new Despesa("Internet", 129.99, "05/03/2025", "Moradia"));
        despesasList.add(new Despesa("Combustível", 200.00, "10/03/2025", "Transporte"));
        despesasList.add(new Despesa("Supermercado", 352.45, "01/03/2025", "Alimentação"));
        despesasList.add(new Despesa("Internet", 129.99, "05/03/2025", "Moradia"));
        despesasList.add(new Despesa("Combustível", 200.00, "10/03/2025", "Transporte"));
    }
    ...
    private void carregarReceitasDemonstracao() {
        ...
        // Adicionar algumas receitas de exemplo
        receitasList.add(new Receita("Salário", 3500.00, "05/03/2025", "Salário"));
        receitasList.add(new Receita("Freelance", 800.00, "15/03/2025", "Freelance"));
        receitasList.add(new Receita("Dividendos", 120.50, "20/03/2025", "Investimentos"));
    }
